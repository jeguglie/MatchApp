...
async function matchAppFaker(req, res) {
    try {
        ...
        await pool.query(text, [process.env.SERVER_LOCALHOST !== "1" ? 'http://matchappli.herokuapp.com/img/patrick-dupont.png' : 'http://localhost:3000/img/patrick-dupont.png', 1001, 0]);
        // Insert complete
        ...
        // Insert Imgs
        text = 'INSERT INTO pictures(img_link, user_id, img_order) VALUES ($1, $2, $3)';
        await pool.query(text, [process.env.SERVER_LOCALHOST !== "1" ? 'http://matchappli.herokuapp.com/img/marine-dupont.png' : 'http://localhost:3000/img/marine-dupont.png', 1002, 0]);
        // Insert complete
        text = 'INSERT INTO user_complete(complete_basics, complete_photos, complete_interets, user_id, complete_location) VALUES ($1, $2, $3, $4, $5)';
