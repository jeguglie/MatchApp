...
async function uploadPhoto(req, res) {
    ...
    try {
        ...
        values = [user_id, JSON.stringify(process.env.SERVER_LOCALHOST) !== JSON.stringify("1") ? 'https://matchappli.herokuapp.com/api/' + pathImg : 'http://localhost:5000/api/' + pathImg, img_order];
